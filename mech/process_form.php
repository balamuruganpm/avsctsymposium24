...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($missingFields)) {
        ...
        $stmt = $conn->prepare("INSERT INTO mechregister (full_name, email, phone_number, dob, gender, whatsapp_number, college, department, year_of_study, technical_event, non_technical_event, pptFile) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
